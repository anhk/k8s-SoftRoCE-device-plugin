...
images: 
	docker build --platform amd64 -f deploy/Dockerfile -t ir0cn/k8s-softroce-device-plugin:amd64 . --push
	docker build --platform arm64 -f deploy/Dockerfile -t ir0cn/k8s-softroce-device-plugin:arm64 . --push
